...
//				}
                ...
                else if (ev2.x - ev.x < Point.PRECISION && ev2.x - ev.x > -Point.PRECISION &&
...
//												if ((i.prev == null || a <= p.y) && (i.next == null || p.y < b)) {
        ...
        void FinishEdges()
        {
            ...
            for (int c = 0; c < cells.Length; c++)
            {
                ...
                for (int k = 0; k < segmentCount; k++)
                {
                    ...
                    if (!s.done || (s.start.x < X0 && s.end.x < X0) || (s.start.y < Y0 && s.end.y < Y0) ||
                        (s.start.x > X1 && s.end.x > X1) || (s.start.y > Y1 && s.end.y > Y1) ||
        ...
        bool GetNearestSegmentPointToCorner(Point corner, List<Segment> segments, bool leftOrRightSides,
            out Point nearest)
        {
